...
*/
    ...
    public String loginCheck(String userID, String userPW, Model model){
        ...
        if (userID.equals("grape111")) equalID = true;
        if (userPW.equals("ggg9999")) equalPW = true;
        if (equalID & equalPW){
            isLogin = true;
        }
        ...
        model.addAttribute("PW",userPW);
        model.addAttribute("isLogin",isLogin);
        model.addAttribute("isId",equalID);
        model.addAttribute("isPw",equalPW);
